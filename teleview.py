...
# --- CONFIG ---
BOT_TOKEN = "8254387734:AAEd4VK_abdQuwgbFEiadoqj7UwlxDpmg3A" # የቦትህን ቶከን እዚህ ተካ
...
class ViewEngine:
    def __init__(self):
        ...
        self.custom_ips = []
        self.sem = asyncio.Semaphore(2500) # በአንድ ጊዜ 2,500 ግንኙነቶች
